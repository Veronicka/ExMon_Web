...
config :ex_mon, ExMonWeb.Endpoint,
  url: [host: "localhost"],
  secret_key_base: "IaSbsIobKzCAT0jmerifpgabZkgN9OO1VIYq3znVcqDd66ctQdVOu+7/1A9ssTIL",
  render_errors: [view: ExMonWeb.ErrorView, accepts: ~w(json), layout: false],
  pubsub_server: ExMon.PubSub,
  live_view: [signing_salt: "pMQ9M0x8"]
...
config :ex_mon, ExMonWeb.Auth.Guardian,
  issuer: "ex_mon",
  secret_key: "ISsZCkie7k95b3k2vL3Cltqz8fAeo5Sm6eb8GThLmoiiZptkzDnfXz9bw7+M+XGJ"
